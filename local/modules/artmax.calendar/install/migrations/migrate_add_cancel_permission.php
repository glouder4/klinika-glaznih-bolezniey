<?php
/**
 * Миграция: добавление права calendar.cancel
 * Отмена записи и возврат в расписание
 *
 * Использование: php migrate_add_cancel_permission.php
 * или через браузер: /local/modules/artmax.calendar/install/migrations/migrate_add_cancel_permission.php
 */
...
$permission = [
    ...
    'NAME' => 'Отмена записи',
    'DESCRIPTION' => 'Право на отмену записи и возврат в расписание. Владелец может отменять свои записи без этого права'
];
